...
const CATEGORIES = ["Kính cận", "Kính râm", "Gọng kính", "Kính cao cấp"];
const MATERIALS = ["Nhựa", "Kim loại", "Titanium", "Acetate", "TR90"];
const SHAPES = ["Chữ nhật", "Tròn", "Oval", "Mắt mèo", "Aviator", "Vuông"];
const COLORS = [
...
export default function ManagerInventoryPage() {
  const [products, setProducts] = useState<Product[]>([
    {
      ...
      description: "Gọng kính chữ nhật thanh lịch, phù hợp cho môi trường công sở",
      category: "Kính cận",
      price: 1890000,
      material: "Acetate",
      shape: "Chữ nhật",
    ...
    },
    {
      id: "2",
      sku: "GK-002",
      name: "Mắt Mèo Hiện Đại",
      description: "Thiết kế mắt mèo thời thượng, tôn lên nét đẹp nữ tính",
      category: "Kính cận",
      price: 2100000,
      material: "Kim loại",
      shape: "Mắt mèo",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formColors.length === 0) {
      alert("Vui lòng thêm ít nhất 1 màu sắc");
      return;
    }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl border-2 border-gray-300 shadow-sm p-6 mb-6">
          ...
          {/* Filters Panel */}
          {showFilters && (
            <div className="grid md:grid-cols-4 gap-4 mt-4 pt-4 border-t-2 border-gray-200">
              <div>
                      ...
                      if (
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1 rounded-lg font-medium border-2 transition-colors ${
                              currentPage === page
                ...
                <div className="border-t-2 border-gray-200 pt-6">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4 border-2 border-blue-200">
                    <div className="grid md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setCurrentColorForm({ ...currentColorForm, colorCode: e.target.value })
                          }
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setCurrentColorForm({ ...currentColorForm, stock: e.target.value })
                          }
                          placeholder="0"
                          className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                        />
                    ...
                    <div className="mb-4">
                      ...
                      {/* Preview Images */}
                      {currentColorForm.images.length > 0 && (
                        <div className="grid grid-cols-4 gap-2 mt-3">
                          {currentColorForm.images.map((img, idx) => (
