...
interface Order {
  ...
  type: "regular" | "prescription" | "pre-order";
  status: string;
  total: number;
  createdAt: string;
  items: Array<{
  ...
  const [orders] = useState<Order[]>([
    {
      ...
      items: [
        ...
        { name: "Tròng kính cao cấp", quantity: 1, price: 79 },
      ],
      prescription: {
        odSph: "-2.50",
        odCyl: "-0.75",
    ...
    },
    {
      ...
      items: [{ name: "Gọng Mắt Mèo", quantity: 1, price: 79 }],
    },
    {
      id: "PRE-2024-001",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            {selectedOrder ? (
              <div className="bg-white border-2 border-orange-300 rounded-2xl overflow-hidden shadow-sm">
                ...
                {selectedOrder.preOrderPreferences && (
                  <div className="p-6 border-b-2 border-orange-200">
                    ...
                    <div className="space-y-4 text-sm">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedOrder.preOrderPreferences.shape.map((shape) => (
                            <span
                              key={shape}
                      ...
                      {selectedOrder.preOrderPreferences.color.length > 0 && (
                        <div>
                          <p className="text-gray-600 mb-2 font-bold">Màu sắc:</p>
                          <div className="flex flex-wrap gap-2">
                            {selectedOrder.preOrderPreferences.color.map((color) => (
                              <span
                                key={color}
                      ...
                      {selectedOrder.preOrderPreferences.material.length > 0 && (
                        <div>
                ...
                <div className="p-6 bg-orange-50">
                  ...
                  <div className="flex gap-3">
                    ...
                    {selectedOrder.status === "Đã xác nhận" && (
                      <button className="flex-1 py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 transition-colors font-bold border-2 border-orange-700">
                        Chuyển sang đang xử lý
                      </button>
                    )}
                    {selectedOrder.type === "pre-order" &&
                      selectedOrder.status === "Đang tìm kiếm" && (
                        <button className="flex-1 py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 transition-colors font-bold border-2 border-orange-700">
                          Thêm sản phẩm gợi ý
                        </button>
                      )}
