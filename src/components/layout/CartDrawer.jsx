...
function CartDrawer({ open, onOpenChange }) {
  ...
  >
    ...
    /* Content */
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {items.length === 0 ? <div className="flex flex-col items-center justify-center h-full text-center py-12">
  ...
  >
    ...
    /* Free Shipping Progress */
              ...
              {subtotal < 100 && <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4">
  ...
  />
    ...
    >
                      ...
                      <div className="space-y-1 text-xs text-muted-foreground mb-2">
                        ...
                        {item.prescriptionDetails ? <>
                          ...
                          </> : item.orderType === "pre-order" ? <p className="text-blue-600">• Pre-order</p> : <p className="text-green-600">• Hàng có sẵn</p>}
                      </div>
    ...
    /* Footer */
        ...
        {items.length > 0 && <div className="border-t border-border px-6 py-4 space-y-4 bg-secondary">
            {
    /* Price Summary */
  }
