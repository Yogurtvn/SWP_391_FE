...
function Header() {
  ...
  const categories = [
    { name: "K\xEDnh C\u1EADn", path: "/shop/eyeglasses" },
    { name: "K\xEDnh R\xE2m", path: "/shop/sunglasses" },
    { name: "G\u1ECDng K\xEDnh", path: "/shop/ai-glasses" },
    { name: "Th\u01B0\u01A1ng Hi\u1EC7u Cao C\u1EA5p", path: "/shop/premium" },
    { name: "Tr\xF2ng K\xEDnh", path: "/shop/lenses" }
  ];
          ...
          <div className="flex items-center gap-6">
            {user ? <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuSeparator />
                  {dashboardPath && <DropdownMenuItem onClick={() => navigate(dashboardPath)} className="cursor-pointer">
  ...
  >
        ...
        {mobileMenuOpen && <nav className="lg:hidden py-4 space-y-2 border-t border-border">
            {categories.map((link) => <Link
    key={link.path}
    to={link.path}
