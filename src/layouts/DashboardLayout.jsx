...
function DashboardLayout() {
  ...
  const getNavigationItems = () => {
    if (user?.role === "admin") {
      return [
        ...
        {
          name: "Qu\u1EA3n L\xFD \u0110\u01A1n H\xE0ng",
          path: "/admin/orders",
          icon: ShoppingCart
        },
        {
          name: "Qu\u1EA3n L\xFD S\u1EA3n Ph\u1EA9m",
          path: "/admin/products",
          icon: Package
        },
        {
        ...
        {
          name: "G\xF3i Tr\xF2ng K\xEDnh",
          path: "/admin/lens-packages",
          icon: Layers
        },
        {
          name: "Qu\u1EA3n L\xFD Users",
          path: "/admin/users",
          icon: Users
        },
        {
  ...
  return <div className="min-h-screen bg-gray-50 flex">
    ...
    /* Sidebar */
      ...
      <aside
    className={`fixed inset-y-0 left-0 z-50 bg-white border-r border-gray-200 transition-all duration-300 ${sidebarOpen ? "w-64" : "w-20"} hidden lg:block`}
  >
  ...
  />
              ...
              </div> : <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center mx-auto">
                <svg
    className="w-5 h-5 text-white"
    fill="none"
    stroke="currentColor"
  ...
  >
              <ChevronDown
    className={`w-4 h-4 transition-transform ${sidebarOpen ? "rotate-0" : "rotate-180"}`}
  />
            </button>
          </div>
    ...
    return <Link
      key={item.path}
      to={item.path}
      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${isActive ? "bg-primary text-white" : "text-gray-700 hover:bg-gray-100"} ${!sidebarOpen && "justify-center"}`}
  ...
  >
    ...
    return <Link
      ...
      to={item.path}
      onClick={() => setMobileMenuOpen(false)}
      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${isActive ? "bg-primary text-white" : "text-gray-700 hover:bg-gray-100"}`}
    >
