...
export default function ShopPage() {
  ...
  const [expandedSections, setExpandedSections] = useState<Set<string>>(
    new Set(['type', 'category', 'availability'])
  );
              ...
              <FilterSection title="Tình Trạng" id="availability">
                <label className="flex items-center gap-3 cursor-pointer">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFilters(prev => ({ ...prev, inStockOnly: checked as boolean }))}
                  />
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFilters(prev => ({ ...prev, preOrderOnly: checked as boolean }))}
                  />
