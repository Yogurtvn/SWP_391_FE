...
function CustomerDashboard() {
  ...
  const activePreOrders = [
    {
      ...
      shapes: ["Ch\u1EEF nh\u1EADt", "Vu\xF4ng"]
    },
    {
      id: "PRE-002",
      createdAt: "08/04/2026",
      status: "\u0110\xE3 t\xECm th\u1EA5y",
      shapes: ["Tr\xF2n"],
      matchedCount: 3
    }
  ];
  ...
  />
                ...
                <div className="text-right">
                  ...
                  <span
    className={`inline-block px-2 py-1 text-xs rounded-full ${order.status === "\u0110\xE3 giao" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}`}
  >
                    {order.status}
                  </span>
                </div>
        ...
        <div className="bg-white border border-border rounded-xl p-6">
          ...
          <div className="space-y-4">
            {activePreOrders.map((preOrder) => <Link
    key={preOrder.id}
    to="/profile/pre-orders"
  ...
  >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span
    className={`text-xs px-2 py-1 rounded-full ${preOrder.status === "\u0110\xE3 t\xECm th\u1EA5y" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}`}
  >
                    {preOrder.status}
                  </span>
                </div>
                <div className="flex flex-wrap gap-2">
                  {preOrder.shapes.map((shape) => <span
    key={shape}
  ...
  >
                ...
                {preOrder.matchedCount && <p className="text-xs text-green-600 mt-2">
