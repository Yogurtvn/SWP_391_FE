...
const orderStatuses = [
  {
    status: "\u0110\xE3 \u0111\u1EB7t",
    date: "10 Th\xE1ng 4, 2026",
    icon: Check,
    completed: true
  },
  {
    status: "\u0110ang x\u1EED l\xFD",
    date: "11 Th\xE1ng 4, 2026",
    icon: Package,
    completed: true
  },
  {
    status: "\u0110ang giao",
    date: "12 Th\xE1ng 4, 2026",
    icon: Truck,
    completed: true
  },
  {
    status: "\u0110\xE3 giao",
    date: "D\u1EF1 ki\u1EBFn 15 Th\xE1ng 4, 2026",
    icon: Home,
    completed: false
  }
];
  ...
  return <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-12">
        <div className="relative">
          {orderStatuses.map((item, index) => <div key={item.status} className="relative flex gap-6 pb-12 last:pb-0">
              <div className="flex flex-col items-center">
                <div
    className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors ${item.completed ? "bg-accent text-white" : "bg-secondary text-muted-foreground"}`}
  >
                  <item.icon className="w-6 h-6" />
                </div>
                {index < orderStatuses.length - 1 && <div
    className={`w-0.5 flex-1 mt-2 ${item.completed ? "bg-accent" : "bg-secondary"}`}
