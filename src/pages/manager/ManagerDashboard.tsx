...
export default function ManagerDashboard() {
  ...
  const alerts = [
    ...
    },
    {
      id: "2",
      type: "info",
      message: "12 đơn hàng đang chờ xử lý",
      action: "Xem đơn hàng",
      link: "/manager/orders",
    },
    {
  ...
  const recentActivities = [
    {
      id: "1",
      text: "Đơn hàng #ORD-12345 đã được cập nhật sang trạng thái 'Đang giao'",
      time: "5 phút trước",
      icon: CheckCircle,
    ...
    {
      id: "2",
      text: "Sản phẩm 'Gọng Aviator Classic' tồn kho thấp (còn 3)",
      time: "15 phút trước",
      icon: AlertCircle,
    ...
    {
      id: "3",
      text: "Pre-order mới từ khách hàng Nguyễn Văn A",
      time: "1 giờ trước",
      icon: Clock,
      color: "text-blue-600",
    },
    {
      id: "4",
      text: "Đánh giá 5 sao cho sản phẩm 'Mắt Mèo Hiện Đại'",
      time: "2 giờ trước",
      icon: Star,
      color: "text-primary",
    },
