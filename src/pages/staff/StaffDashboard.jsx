...
function StaffDashboard() {
    ...
    /* Prescription Review Section */
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200">
        ...
        <div className="space-y-3">
          {prescriptionReviews.map((review) => <div
    key={review.id}
  ...
  >
              ...
              <div className="flex items-center justify-between">
                <div>
                  {review.uploadedImage && <span className="text-xs px-2.5 py-1 bg-white border border-cyan-300 rounded-md inline-flex items-center gap-1">
                      📷 Có ảnh đơn thuốc
                    </span>}
                </div>
                <button
